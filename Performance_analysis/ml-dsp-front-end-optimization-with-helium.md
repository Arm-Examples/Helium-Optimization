...
(not sure how we get them with vcpkg: ?? vcpkg use avh-fvp)


As an example

```
VHT_MPS3_Corstone_SSE-300 –f config_sse300.txt
VHT-Corstone-300/Release/Audiomark_app.axf --plugin TARMACTrace.so
```
...
72319160000 ps cpu0 IT (1807979) 0006e1b4 f00fc809 T thread : LE LR,
\#-0x9
72319160000 ps cpu0 R r14 00000040
72319200000 ps cpu0 IT (1807980) 0006e1a6 fe206f60 T thread : VQADD.U32
Q3, Q0, R0
...
72319320000 ps cpu0 IT (1807983) 0006e1ac fe630f87 T thread : VPT.U32
HI, Q1, Q3
72319320000 ps cpu0 R cpsr 01002000
72319320000 ps cpu0 R VPR 0008ffff
72319320000 ps cpu0 R EXCEPTION_PC 0006e1ac
72319360000 ps cpu0 IT (1807984) 0006e1b0 eca85f04 T thread : VSTRWT.32
Q2, \[R8\], \#0x10
```
...
instructions into bins and generating an histogram. Histogram samples
...
MDK can export ETM trace in a CSV format which can be manipulated via
